...
func (c *noteV1Client) Delete(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
func (UnimplementedNoteV1Server) Delete(context.Context, *UpdateRequest) (*emptypb.Empty, error) {
...
func _NoteV1_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NoteV1Server).Delete(ctx, req.(*UpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
